...
if __name__ == "__main__":
    ...
    print('[OPTION] #2 : Gather onion links based on your search Query')
    print('[OPTION] #3 : Gather onion links based on your search Query and Scrap them')
    ...
    if (options == '1') :
        ...
        print('Choose the Correct Options pleaseee...')
